...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_m_axis_mm2s_tdata_width {16} CONFIG.c_mm2s_genlock_mode {2} CONFIG.c_mm2s_linebuffer_depth {4096} CONFIG.c_num_fstores {3} CONFIG.c_s2mm_genlock_mode {3} CONFIG.c_s2mm_linebuffer_depth {4096} CONFIG.c_use_s2mm_fsync {1}  ] $axi_vdma_0

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_0 ]
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {185.829} CONFIG.CLKOUT1_PHASE_ERROR {148.986} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {148.5} CONFIG.CLKOUT2_JITTER {183.543} CONFIG.CLKOUT2_PHASE_ERROR {148.986} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {158.5} CONFIG.CLKOUT2_USED {true} CONFIG.MMCM_CLKFBOUT_MULT_F {12.625} CONFIG.MMCM_CLKOUT0_DIVIDE_F {4.250} CONFIG.MMCM_CLKOUT1_DIVIDE {4} CONFIG.MMCM_DIVCLK_DIVIDE {2} CONFIG.NUM_OUT_CLKS {2} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.C_S_AXIS_VIDEO_DATA_WIDTH {8} CONFIG.C_S_AXIS_VIDEO_FORMAT {0} CONFIG.C_S_AXIS_VIDEO_MAX_TDATASMPLS_PER_CLK {1} CONFIG.HYSTERESIS_LEVEL {1000} CONFIG.RAM_ADDR_BITS {10} CONFIG.VTG_MASTER_SLAVE {1}  ] $v_axi4s_vid_out_0
...
CONFIG.enable_detection {false}  ] $v_tc_0
  ...
  set_property -dict [ list CONFIG.enable_motion {false} CONFIG.has_axi4_lite {false} CONFIG.has_axi4s_slave {false} CONFIG.m_video_format {0} CONFIG.pattern_control {15}  ] $v_tpg_0
  ...
  set_property -dict [ list CONFIG.DIN_FROM {0} CONFIG.DIN_TO {0} CONFIG.DIN_WIDTH {16}  ] $xlslice_3
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins xlslice_3/Din] [get_bd_pins zed_hdmi_out_0/video_data]
  ...
  connect_bd_net -net v_tc_0_fsync_out [get_bd_pins axi_vdma_0/s2mm_fsync] [get_bd_pins v_tc_0/fsync_out] [get_bd_pins v_tpg_0/aresetn] [get_bd_pins xlconcat_1/In6]
  ...
  connect_bd_net -net vcc_dout [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tpg_0/aclken] [get_bd_pins vcc/dout]
